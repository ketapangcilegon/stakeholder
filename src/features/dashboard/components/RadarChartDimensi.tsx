...
import { DimensionScore } from '@/lib/utils/scoring';
import { DIMENSI_LIST, STAKEHOLDER_GROUPS } from '@/config/constants';

interface Props {
  dimensionScores: DimensionScore[];
  stakeholderProgress: any[];
}

export default function RadarChartDimensi({ dimensionScores, stakeholderProgress }: Props) {
  ...
  const stakeholderColors: Record<string, string> = {
    pemda: '#2563eb',
    pelaku_usaha: '#10b981',
    masyarakat_pesisir: '#f59e0b',
    akademisi_lsm: '#8b5cf6',
    industri: '#06b6d4',
  };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
        <div>
          ...
          <p className="text-xs text-slate-500">
            Skala 1.0 s/d 5.0 (Skor komposit per dimensi)
          </p>
        </div>
