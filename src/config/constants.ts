// ==================================================================================
// KONFIGURASI & KONSTANTA METADATA PENELITIAN TESIS
...
export const VARIABEL_LIST: Variabel[] = [
  { id: "V1", id_dimensi: "ekologi", nama: "Persepsi Kondisi Ekologi", deskripsi: "Kondisi stok ikan, mutu perairan, dampak penangkapan, dan dampak industri.", urutan: 1 },
  { id: "V2", id_dimensi: "ekonomi", nama: "Persepsi Aspek Ekonomi", deskripsi: "Kontribusi ekonomi perikanan, beban operasional, stabilitas harga TPI, dan nilai tambah.", urutan: 2 },
  { id: "V3", id_dimensi: "sosial", nama: "Persepsi Aspek Sosial", deskripsi: "Kohesi sosial nelayan, mitigasi konflik ruang perairan, keadilan akses, dan regenerasi.", urutan: 3 },
  { id: "V4", id_dimensi: "tata_kelola", nama: "Persepsi Tata Kelola (Governance)", deskripsi: "Transparansi, keterbukaan keputusan, koordinasi lintas sektor, konsistensi regulasi, dan basis data.", urutan: 4 },
  { id: "V5", id_dimensi: "kelembagaan", nama: "Persepsi Kelembagaan", deskripsi: "Kapasitas kelembagaan, efektivitas kelompok nelayan/koperasi, peran penyuluh, dan kejelasan wewenang.", urutan: 5 },
  { id: "V6", id_dimensi: "tata_kelola", nama: "Tingkat Dukungan Stakeholder", deskripsi: "Penerimaan kebijakan keberlanjutan, kepatuhan aturan penangkapan, dan kesediaan kolaborasi.", urutan: 6 },
  { id: "V7", id_dimensi: "tata_kelola", nama: "Intensitas Partisipasi", deskripsi: "Keikutsertaan dalam musyawarah, konsultasi publik, penyampaian aspirasi, perumusan, dan pengawasan.", urutan: 7 },
  { id: "V8", id_dimensi: "kelembagaan", nama: "Kepentingan (Interest) Stakeholder", deskripsi: "Ketergantungan ekonomi, kepentingan sosial budaya, dampak kebijakan, dan atensi regulasi.", urutan: 8 },
  { id: "V9", id_dimensi: "kelembagaan", nama: "Pengaruh (Influence) Stakeholder", deskripsi: "Kewenangan hukum, akses ke penentu kebijakan, penguasaan informasi/riset, dan mobilisasi sumber daya.", urutan: 9 }
];
...
export const INDIKATOR_LIST: Indikator[] = [
  ...
  { id: "IND_25", id_variabel: "V6", kode: "DUK-02", deskripsi: "Dukungan terhadap target pengelolaan perikanan yang berkelanjutan", urutan: 25 },
  { id: "IND_26", id_variabel: "V6", kode: "DUK-03", deskripsi: "Kepatuhan terhadap batas zonasi melaut, perizinan, dan alat tangkap legal", urutan: 26 },
  { id: "IND_27", id_variabel: "V6", kode: "DUK-04", deskripsi: "Kesediaan berkontribusi aktif mendukung program perlindungan laut Cilegon", urutan: 27 },
...
export const TOTAL_INDICATORS = INDIKATOR_LIST.length; // 42
